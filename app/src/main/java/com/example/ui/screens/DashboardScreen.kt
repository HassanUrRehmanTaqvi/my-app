    ...
    LazyColumn(
        ...
        item {
            AcademicHeader(
                ...
                teacherName = currentUser?.name ?: "پروفیسر حسن الرحمن تقوی",
                designation = currentUser?.designation ?: "لیکچرار اسلامیات",
                academicYear = "2026–27"
            )
        }

        // 2. Validation Warning Banner (Nominal Roll Alerts)
        ...
        // 3. Today's Date Banner & Quick Actions
        item {
            Card(
                ...
                Column(modifier = Modifier.padding(14.dp)) {
                    ...
                    Row(
                        ...
                        OutlinedButton(
                            ...
                            modifier = Modifier
                                .weight(1f)
                                .testTag("quick_create_class_button"),
                            shape = RoundedCornerShape(10.dp)
                        ) {
                            Icon(
        ...
        item {
            Row(
                ...
                StatCard(
                    ...
                    value = "${students.count { it.className == "First Year" }}",
                ...
                StatCard(
                    ...
                    value = "${students.count { it.className == "Second Year" }}",
                    icon = Icons.Default.School,
        ...
        // 5. Teacher's Active Classes Section
        item {
            Row(
                modifier = Modifier.fillMaxWidth(),
                horizontalArrangement = Arrangement.SpaceBetween,
